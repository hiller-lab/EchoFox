...
def plot1d(
    ...
    **kwargs,
    ...
    if f1_ticklabel_kwargs is None:
        f1_ticklabel_kwargs = {}
    if intensity_label_kwargs is None:
        intensity_label_kwargs = {}
    if intensity_ticklabel_kwargs is None:
        intensity_ticklabel_kwargs = {}
    ...
    for i, spectrum in enumerate(spectra):
        if spectrum.data.ndim == 1:  # normal 1D spectrum
            ...
            ax.set_xlim(
                spectrum.dimension_ranges[0].high_ppm,
                spectrum.dimension_ranges[0].low_ppm,
            )
            ...
            ax.set_xlim(
                spectrum.dimension_ranges[1].high_ppm,
                spectrum.dimension_ranges[1].low_ppm,
            )
    ...
    if show_intensity_axis and show_intensity_label:
        ax.set1D_intensity_label_text(
            label=label,
            pos=intensity_label_kwargs.pop("pos", None),
